...
echo ""
echo -e "                 \033[1;31mBy @LUFFYELBRABO\033[1;36m"
echo ""
...
echo -e 'By: @luffyelbrabo' > /etc/rec/licence
echo -e 'By: @luffyelbrabo' > /usr/lib/licence
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@LUFFYELBRABO\033[0m"
